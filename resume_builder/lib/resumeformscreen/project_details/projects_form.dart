...
class _ProjectFormState extends State<ProjectForm> {
  ...
  Future saveProjectInfoDB() async {
    setState(() {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Text(
                                "You have already added the maximum number of project details.",
                              ),
                              actions: [
                                TextButton(
                                  onPressed: () {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              ...
                                              content: Text(
                                                  "You have already added maximum number of project details."),
                                              actions: <Widget>[
                                                TextButton(
                                                  onPressed: () {
