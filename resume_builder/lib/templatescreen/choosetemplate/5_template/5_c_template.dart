...
import 'package:resume_builder/templatescreen/choosetemplate/5_template/5_classic.dart';
...
void main() {
  runApp(MaterialApp(
    ...
    home: ResumeClassicPage5(),
  )); // MaterialApp
}

class ResumeClassicPage5 extends StatefulWidget {
  const ResumeClassicPage5({Key? key}) : super(key: key);

  @override
  State<ResumeClassicPage5> createState() => _ResumeClassicPageState5();
}

class _ResumeClassicPageState5 extends State<ResumeClassicPage5>
...
const examples = [
  Example('Resume', 'resume.dart', templateDesigner5),
];
