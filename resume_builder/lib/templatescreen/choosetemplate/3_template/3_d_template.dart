...
class ResumeClassicPage extends StatefulWidget {
  const ResumeClassicPage({Key? key}) : super(key: key);

  @override
  State<ResumeClassicPage> createState() => _ResumeClassicPageState();
}

class _ResumeClassicPageState extends State<ResumeClassicPage> with SingleTickerProviderStateMixin {
...
const examples = [
  Example('Resume', 'resume.dart',templateDesigner3 ),
];
