...
Future<Uint8List> templateDesigner3
(PdfPageFormat format, List<dynamic> data) async {
  final doc = pw.Document(title: 'My Resume', author: 'Husain Jinia');
                ...
                child:pw.Column(
                    children: [
                      pw.Row(
                          ...
                          children: [
                            pw.Text(data[0]["fname"], style:  pw.TextStyle(fontSize: 25,fontWeight: pw.FontWeight.bold,color:PdfColors.teal500)),
                            pw.SizedBox(width: 5,),
                            pw.Text(data[0]["mname"], style:  pw.TextStyle(fontSize: 25,fontWeight: pw.FontWeight.bold,color:PdfColors.teal500)),
                            pw.SizedBox(width: 5,),
                            pw.Text(data[0]["lname"], style:  pw.TextStyle(fontSize: 25,fontWeight: pw.FontWeight.bold,color:PdfColors.teal500)),
                            pw.SizedBox(width: 5,),
                          ]
                      ),
                      pw.Row(
                          mainAxisAlignment: pw.MainAxisAlignment.end,
                          children: [
                            pw.Text(data[0]["flat/house"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                            pw.Text(data[0]["area"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                          ]
                      ),
                      pw.Row(
                          mainAxisAlignment: pw.MainAxisAlignment.end,
                          children: [
                            pw.Text(data[0]["landmark"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                          ]
                      ),
                      pw.Row(
                          mainAxisAlignment: pw.MainAxisAlignment.end,
                          children: [
                            pw.Text(data[0]["city"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                            pw.Text(data[0]["state"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                            pw.Text(data[0]["pincode"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                      ...
                      pw.Row(
                          mainAxisAlignment: pw.MainAxisAlignment.end,
                          children: [
                            pw.Text(data[0]["email"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                            pw.Text(data[0]["mobile"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
                            pw.Text("  ,  "),
                            pw.Text(data[0]["socialmedia"],style: const pw.TextStyle(fontSize: 12,color:PdfColors.teal500)),
