...
import 'package:resume_builder/templatescreen/choosetemplate/4_template/4_classic.dart';
...
class ResumeClassicPage4 extends StatefulWidget {
  const ResumeClassicPage4({Key? key}) : super(key: key);

  @override
  State<ResumeClassicPage4> createState() => _ResumeClassicPage4State();
}

class _ResumeClassicPage4State extends State<ResumeClassicPage4> with SingleTickerProviderStateMixin {
...
const examples = [
  Example('Resume', 'resume.dart',templateClassic4 ),
];
