...
void main() {
  runApp(MaterialApp(
    ...
    home: ResumeClassicPage6(),
  )); // MaterialApp
}

class ResumeClassicPage6 extends StatefulWidget {
  const ResumeClassicPage6({Key? key}) : super(key: key);

  @override
  State<ResumeClassicPage6> createState() => _ResumeClassicPageState6();
}

class _ResumeClassicPageState6 extends State<ResumeClassicPage6>
...
const examples = [
  Example('Resume', 'resume.dart', templateClassic6),
];
